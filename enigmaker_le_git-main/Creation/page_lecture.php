...
<html lang="en" dir="ltr">
   ...
   include ("../Inclusion/menu_haut.php");
    ...
    <div class="creaDiv" > 
    <p class='info__'>choisissez les énigmes qui constitueront le parcours </p>
...
<!--<button onclick="location.href='../Creation/index.php'" type="button">
         ...
         <h3 class="inscric">Veuillez saisir le titre du parcours</h3>
...
<form class=""method="post" action="">
        ...
        <input name="vali_mission" type="submit" value="créer le parcours"
